...
**box plot shows the relationship between Species and flipper_length_mm. On average the flipper_length_mm for Gentoo is greater then the other two species**:
...
**jitterplot has distributed the samples based on the flipper_length_mm. Different clusters can been seen from the plot above.**:
...
**the md file is readable and looks more professional**:
...
**I would prefer jitterplot over box plot. because of more visibilty.**:
...
**Easier to write the code if used in ggplot compared to have it write in each layer**:
